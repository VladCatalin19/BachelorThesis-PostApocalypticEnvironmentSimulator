    ...
    public class IvyProfileEditor : Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            if ( ivyProfile.showGrowthFoldout ) {
                ...
                EditorGUILayout.MinMaxSlider(ref ivyProfile.minLength, ref ivyProfile.maxLength, 0.01f, 20f);
                ivyProfile.maxLength = Mathf.Clamp(EditorGUILayout.DelayedFloatField( ivyProfile.maxLength, GUILayout.MaxWidth(28) ), ivyProfile.minLength+0.01f, 20f);
                EditorGUI.indentLevel++;
